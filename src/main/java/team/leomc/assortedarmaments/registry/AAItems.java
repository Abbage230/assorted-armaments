...
public class AAItems {
	...
	// rapiers
	public static final DeferredItem<RapierItem> WOODEN_RAPIER = ITEMS.register("wooden_rapier", () -> new RapierItem(Tiers.WOOD, new Item.Properties().attributes(RapierItem.createAttributes(Tiers.WOOD, 1.5f, -2f))));
	public static final DeferredItem<RapierItem> STONE_RAPIER = ITEMS.register("stone_rapier", () -> new RapierItem(Tiers.STONE, new Item.Properties().attributes(RapierItem.createAttributes(Tiers.STONE, 1.5f, -2f))));
	...
	public static final DeferredItem<RapierItem> GOLDEN_RAPIER = ITEMS.register("golden_rapier", () -> new RapierItem(Tiers.GOLD, new Item.Properties().attributes(RapierItem.createAttributes(Tiers.GOLD, 1.5f, -2f))));
	public static final DeferredItem<RapierItem> DIAMOND_RAPIER = ITEMS.register("diamond_rapier", () -> new RapierItem(Tiers.DIAMOND, new Item.Properties().attributes(RapierItem.createAttributes(Tiers.DIAMOND, 1.5f, -2f))));
	public static final DeferredItem<RapierItem> NETHERITE_RAPIER = ITEMS.register("netherite_rapier", () -> new RapierItem(Tiers.NETHERITE, new Item.Properties().attributes(RapierItem.createAttributes(Tiers.NETHERITE, 1.5f, -2f))));
}
